<template>
  <div class="ui-draggable-offset">
    ...
    <div v-if="isSize" class="ew absolute size" @mousedown.prevent="startMove($event, 'ew')"></div>
    <div v-if="isSize" class="ns absolute size" @mousedown.prevent="startMove($event, 'ns')"></div>
    <div v-if="isSize" class="se absolute size" @mousedown.prevent="startMove($event, 'se')"></div>
  </div>
</template>
